...
export const translations: Translations = {
  pt: {
    ...
    summary: {
      ...
      body: 'Desenvolvedor Full Stack com foco em IA Generativa. Atuo no desenvolvimento de soluções completas utilizando <strong>React (TypeScript)</strong> no frontend e <strong>Python (FastAPI)</strong> no backend, com experiência também em <strong>Node.js (NestJS)</strong>, <strong>C# (.NET)</strong> e bancos de dados como <strong>PostgreSQL</strong>. Experiência prática com <strong>Docker</strong>, <strong>Azure</strong> e implementação de arquiteturas modernas com LLMs (<strong>RAG</strong>, <strong>Agentes Autônomos</strong>). Focado em entregar software de qualidade, com boas práticas e foco em performance e manutenção.',
    },
    experience: {
      ...
      items: [
        {
          ...
          description: [
            '• Desenvolvimento de agentes e pipelines RAG (ingestão, chunking, embeddings) utilizando LangChain e LangGraph.',
            '• Implementação de APIs REST com Python (FastAPI) e integração com OpenAI.',
            '• Construção de interfaces modernas com React + TypeScript e gerenciamento de dados em PostgreSQL.',
            'Tecnologias: LangChain • LangGraph • FastAPI • React • PostgreSQL • Azure • Docker • Git • OpenAI',
          ],
        },
        {
          ...
          description: [
            '• Desenvolvimento e manutenção de funcionalidades no sistema interno utilizando JavaScript.',
            '• Execução de consultas SQL no PostgreSQL para suporte à tomada de decisão e análise de dados.',
            '• Colaboração com o time de produtos na definição técnica de novas funcionalidades.',
            'Tecnologias: JavaScript • PostgreSQL • Git',
          ],
        },
        {
          ...
          description: [
            '• Auxiliei no aprendizado de Java e PHP, usando métodos didáticos diferenciados.',
            '• Contribuí diretamente para o aprendizado acadêmico e aprimorei habilidades de comunicação.',
            'Tecnologias: Java • PHP • POO • Ensino',
          ],
        },
        {
          ...
          description: [
            '• Utilizei métodos inovadores de ensino para facilitar a compreensão da lógica de programação.',
            '• Desenvolvi habilidades de comunicação e didática ao explicar algoritmos fundamentais.',
            'Tecnologias: Lógica de Programação • C',
          ],
        },
      ],
    },
    skills: {
      ...
      categories: [
        {
          title: 'Stack Principal (Foco)',
          tags: 'React • TypeScript • Python • FastAPI • PostgreSQL • Docker • Azure • RAG/Agents',
        },
        {
          title: 'Também já utilizei',
          tags: 'C# (.NET), Java (Spring Boot), PHP (Laravel), C/C++, JavaScript (ES6+), HTML5/CSS3, Node.js (NestJS), TailwindCSS.',
        },
        {
          title: 'IA & Dados',
          tags: 'LangChain, LangGraph, OpenAI API, Pandas/NumPy, Vetores & Embeddings.',
        },
        {
          title: 'Ferramentas & DevOps',
          tags: 'Git/GitHub, Linux, VS Code, Postman.',
        },
      ],
    },
    education: {
    ...
    courses: {
      ...
      items: {
        featured: [
          ...
          '<strong>Ministrante: Minicurso Mineração de Dados</strong> - IFSP (Mai 2023)',
        ],
        others: [
  ...
  en: {
    ...
    summary: {
      ...
      body: 'Full Stack Developer focused on Generative AI. I work on developing complete solutions using <strong>React (TypeScript)</strong> on the frontend and <strong>Python (FastAPI)</strong> on the backend, also obtaining experience with <strong>Node.js (NestJS)</strong>, <strong>C# (.NET)</strong> and databases like <strong>PostgreSQL</strong>. Practical experience with <strong>Docker</strong>, <strong>Azure</strong>, and implementation of modern LLM architectures (<strong>RAG</strong>, <strong>Autonomous Agents</strong>). Focused on delivering high-quality software, with best practices and a focus on performance and maintainability.',
    },
    experience: {
      ...
      items: [
        {
          ...
          description: [
            '• Development of agents and RAG pipelines (ingestion, chunking, embeddings) using LangChain and LangGraph.',
            '• Implementation of REST APIs with Python (FastAPI) and integration with OpenAI.',
            '• Construction of modern interfaces with React + TypeScript and data management in PostgreSQL.',
            'Technologies: LangChain • LangGraph • FastAPI • React • PostgreSQL • Azure • Docker • Git • OpenAI',
          ],
        },
        {
          ...
          description: [
            '• Development and maintenance of features in the internal system using JavaScript.',
            '• Execution of SQL queries in PostgreSQL to support decision-making and data analysis.',
            '• Collaboration with the product team on the technical definition of new functionalities.',
            'Technologies: JavaScript • PostgreSQL • Git',
          ],
        },
        {
          ...
          date: 'Mar 2023 – Nov 2023',
          description: [
            '• Assisted in teaching Java and PHP, using differentiated didactic methods.',
            '• Contributed directly to students\' academic learning and improved communication skills.',
            'Technologies: Java • PHP • OOP • Teaching',
          ],
        },
        {
          ...
          description: [
            ...
            'Technologies: Programming Logic • C',
          ],
        },
      ],
    },
    skills: {
      ...
      categories: [
        ...
        {
          title: 'AI & Data',
          tags: 'LangChain, LangGraph, OpenAI API, Pandas/NumPy, Vectors & Embeddings.',
        },
        {
          title: 'Tools & DevOps',
          tags: 'Git/GitHub, Linux, VS Code, Postman.',
    ...
    courses: {
      ...
      items: {
        featured: [
          ...
          '<strong>Speaker: Data Mining Workshop</strong> - IFSP (May 2023)',
        ],
        others: [
